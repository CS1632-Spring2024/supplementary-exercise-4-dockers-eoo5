...
public class D3Test {
    ...
    public void tEST2RESET() {
        ...
        driver.findElement(By.cssSelector(".form-group:nth-child(3) .btn")).click();
        driver.get("http://localhost:8080reset");
        assertThat(driver.findElement(By.cssSelector("div#listing li:nth-child(1)")).getText(),
                is("ID 1. Jennyanydots"));
        assertThat(driver.findElement(By.cssSelector("div#listing li:nth-child(2)")).getText(),
                is("ID 2. Old Deuteronomy"));
        assertThat(driver.findElement(By.cssSelector("div#listing li:nth-child(3)")).getText(),
